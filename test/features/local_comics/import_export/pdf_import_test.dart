...
void main() {
  ...
  group('PDF import lifecycle', () {
    ...
    setUp(() async {
      ...
      cacheDirectory = Directory.systemTemp.createTempSync('venera-pdf-cache-');
    ...
    test(
      ...
      () async {
        ...
        expect(
          document.pages.every((page) => page.renderedImage?.disposed == true),
          isTrue,
        );
      },
    );
